...
import biocosmetik.data.models.MInventarioMateriaPrima;
 ...
 * @author 43699891
 */
public class FInventarioMateriaPrima extends mcontrols.ui.MPanel {

    /**
     * Creates new form FmateriaPrima
     */
    public FInventarioMateriaPrima(Session session) {
    ...
    private void initComponents() {
        ...
        mTitleLabel1.setText("Inventario de materias primas");
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${materiaPrima.nombre}"));
        columnBinding.setColumnName("Materia Prima");
        columnBinding.setColumnClass(String.class);
        ...
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${materiaPrima.unidadMedida.unidad}"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, dataTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement}"), model, org.jdesktop.beansbinding.BeanProperty.create("inventarioMateriaPrima"));
        bindingGroup.addBinding(binding);

        jLabel27.setText("Materia prima");
        ...
        jComboBox8.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(
                ...
                if (value instanceof biocosmetik.data.objects.MateriaPrima) {
                    biocosmetik.data.objects.MateriaPrima mp = (biocosmetik.data.objects.MateriaPrima)value;
                    setText(mp.getClave() + " - " + mp.getNombre());
                }
                return this;
            }
        });
        ...
        bindingGroup.addBinding(jComboBoxBinding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, dataTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.materiaPrima}"), jComboBox8, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, dataTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.materiaPrima.unidadMedida.unidad}"), jLabel4, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
        ...
        mPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(mPanel3Layout.createSequentialGroup()
                ...
                .addGroup(mPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jComboBox6, 0, 321, Short.MAX_VALUE)
                    .addComponent(jComboBox7, javax.swing.GroupLayout.Alignment.TRAILING, 0, 321, Short.MAX_VALUE)
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        InventarioMateriaPrima imp = new InventarioMateriaPrima();
        this.data.add(imp);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        int s = this.dataTable.getSelectedRow();
        if (this.movimiento.equals(Movimiento.NUEVO)) {
            this.model.insert(this.model.getInventarioMateriaPrima());
        } else if (this.movimiento.equals(Movimiento.EDITAR)) {
            this.model.edit(this.model.getInventarioMateriaPrima());
        }
        this.bindingGroup.unbind();
        this.enableControls(false);
        this.bindingGroup.bind();
    ...
    private void jComboBox8FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jComboBox8FocusLost
        String unidad = this.model.getInventarioMateriaPrima().getMateriaPrima().getUnidadMedida().getUnidad();
        this.jLabel4.setText(unidad);
    ...
    private java.util.List<biocosmetik.data.objects.InventarioMateriaPrima> data;
    private MInventarioMateriaPrima model;
