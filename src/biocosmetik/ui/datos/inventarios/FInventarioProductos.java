...
import biocosmetik.data.models.MInventarioProductos;
 ...
 * @author 43699891
 */
public class FInventarioProductos extends mcontrols.ui.MPanel {

    /**
     * Creates new form FmateriaPrima
     */
    public FInventarioProductos(Session session) {
    ...
    private void initComponents() {
        ...
        model = new MInventarioProductos(session);
        data = model.getList();
        ...
        mTitleLabel1.setText("Inventario de productos");
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${producto.nombre}"));
        ...
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${producto.unidadMedida.unidad}"));
        columnBinding.setColumnName("Unidad de medida");
        columnBinding.setColumnClass(String.class);
        columnBinding.setEditable(false);
        ...
        jComboBox8.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(
                JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                super.getListCellRendererComponent(list, value, index, isSelected, cellHasFocus);
                if (value instanceof biocosmetik.data.objects.Productos) {
                    biocosmetik.data.objects.Productos p = (biocosmetik.data.objects.Productos)value;
                    setText(p.getClaveAsignadaCliente() + " " + p.getNombre());
                }
                return this;
            }
        });
        ...
        mPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(mPanel3Layout.createSequentialGroup()
                ...
                .addGroup(mPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jComboBox6, 0, 506, Short.MAX_VALUE)
                    .addComponent(jComboBox7, javax.swing.GroupLayout.Alignment.TRAILING, 0, 506, Short.MAX_VALUE)
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        InventarioProductos ip = new InventarioProductos();
        this.data.add(ip);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        int s = this.dataTable.getSelectedRow();
        this.model.save(this.model.getInventarioProductos());
        this.bindingGroup.unbind();
        this.enableControls(false);
        this.bindingGroup.bind();
    ...
    private void jComboBox8FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jComboBox8FocusLost
        String unidad = this.model.getInventarioProductos().getProducto().getUnidadMedida().getUnidad();
    ...
    private java.util.List<biocosmetik.data.objects.InventarioProductos> data;
    private MInventarioProductos model;
